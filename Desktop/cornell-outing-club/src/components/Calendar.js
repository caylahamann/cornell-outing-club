    ...
    render() {
        return (
            <div>
                ...
                <CalendarEvent date= "9/07" difficulty="other" description="Waterfalls of Ithaca Presentation" info="Come listen to a free presentation about the waterfalls of Ithaca!" time="7:00-7:45 PM" location="Lime Hollow Center for Environment and Culture, 338 McLean Rd, Cortland, NY 13045, USA"/>
